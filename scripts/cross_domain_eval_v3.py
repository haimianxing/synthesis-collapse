#!/usr/bin/env python3
"""
Cross-domain evaluation of V3 QD vs Greedy self-synthesis models.
Evaluates GSM8K-trained models on MATH, SVAMP, ASDiv to test generalization.
Uses offline mode for all datasets.

Usage:
  CUDA_VISIBLE_DEVICES=3 python cross_domain_eval_v3.py
"""
...
MODELS = {
    ...
    "qd_r3": "/mnt/data2/zcz/neurIps-emnlp/neurips/results/self_synthesis_v3_base_reset/qd_s42/merged_qd_s42_r3",
    "qd_r4": "/mnt/data2/zcz/neurIps-emnlp/neurips/results/self_synthesis_v3_base_reset/qd_s42/merged_qd_s42_r4",
    "greedy_r3": "/mnt/data2/zcz/neurIps-emnlp/neurips/results/self_synthesis_v3_base_reset/greedy_s42/merged_greedy_s42_r3",
    "greedy_r4": "/mnt/data2/zcz/neurIps-emnlp/neurips/results/self_synthesis_v3_base_reset/greedy_s42/merged_greedy_s42_r4",
    "base": "/home/zcz/.cache/modelscope/hub/Qwen/Qwen2___5-7B-Instruct",
}
OUTPUT_DIR = "/mnt/data2/zcz/neurIps-emnlp/neurips/results/cross_domain_eval_v3"
N_TEST = 500
MAX_NEW_TOKENS = 512
...
def evaluate_benchmark(model, tokenizer, dataset_name, n_test=500):
    ...
    if dataset_name == "gsm8k":
        ...
        questions = [{"q": item["problem"], "a": str(item["answer"])} for item in ds]
...
def main():
    ...
    for model_name, model_path in MODELS.items():
        ...
        save_data = {bench: {k: v for k, v in data.items()} for bench, data in model_results.items()}
    ...
    for model_name, model_results in all_results.items():
        ...
        for bench, data in model_results.items():
            summary[model_name][bench] = {k: v for k, v in data.items()}
